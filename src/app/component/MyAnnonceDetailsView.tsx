  ...
  return (
    <article className="flex flex-col gap-4 bg-white shadow-lg rounded-xl p-4 w-full max-w-[90%] sm:max-w-[80%] md:max-w-[70%] lg:max-w-[60%] xl:max-w-[50%] mx-auto my-6">
      ...
      <div className="p-0">
        ...
        <h1 className="text-xl text-black sm:text-2xl font-bold my-2">{"description"}</h1>
        ...
        <div className="hover:bg-gray-100 rounded-md p-0">
          ...
          <div className="flex justify-between items-center">
            <span className="text-sm text-black sm:text-base font-bold">{i18nPrix}</span>
            <p className="text-base text-black sm:text-lg text-green-800 font-bold">
              {annonce?.price} {"MRU"}
            </p>
          </div>
          <div className="border-t border-green-800 my-2"></div>
        ...
        <div className="flex flex-col sm:flex-row justify-between mt-4 gap-2">
          ...
          >
            {isDeleting ? <div className="loader"></div> : <span>{"Delete"}</span>}
          </button>
          <button
            data-cy="edit-button"
            onClick={handleEdit}
